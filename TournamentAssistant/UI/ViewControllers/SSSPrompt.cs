...
{
    [HotReload(RelativePathToLayout = @"SSSPrompt.bsml")]
    internal class SSSPrompt : BSMLAutomaticViewController
    {
        public event Action Cancel;

        [UIValue("update-title-text")]
        private string updateTitleText = "Plugins Required";

        [UIValue("update-warning-text")]
        private string updateWarningText = "An additional set of mods is required for this week's songs\nIf you'd like, we can install them for you automatically.\nYour game will be restarted once the download is complete.";
        ...
        [UIValue("update-text")]
        private string updateText = "Install";
        ...
        public Task OnUpdateClicked()
        {
            ...
            return TemporarySSSTools.DownloadNecessaryPlugins(OnDownloadProgress);
        }
