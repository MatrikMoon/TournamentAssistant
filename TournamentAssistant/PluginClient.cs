            ...
            if (packet.Type == PacketType.PlaySong)
            {
                ...
                if (playSong.GameplayParameters.PlayerSettings.Options != PlayerOptions.None)
                {
                    playerSettings = new PlayerSpecificSettings(
                        ...
                        playSong.GameplayParameters.PlayerSettings.GetField<NoteJumpDurationTypeSettings>("noteJumpDurationTypeSettings"),
                        playSong.GameplayParameters.PlayerSettings.GetField<float>("noteJumpFixedDuration"),
