...
export interface Command {
    ...
    type: {
        ...
        oneofKind: "loadSong";
        /**
         * @generated from protobuf field: proto.packets.Command.LoadSong load_song = 5;
         */
        ...
        oneofKind: "showModal";
        /**
         * @generated from protobuf field: proto.packets.Command.ShowModal show_modal = 8;
         */
...
/**
 * @generated from protobuf message proto.packets.Command.LoadSong
 */
...
/**
 * @generated from protobuf message proto.packets.Command.ShowModal
 */
...
export interface Request {
    ...
    type: {
        ...
        /**
         * @generated from protobuf field: proto.packets.Request.PreloadImageForStreamSync preload_image_for_stream_sync = 4;
         */
...
export interface Response {
    ...
    details: {
        ...
        /**
         * @generated from protobuf field: proto.packets.Response.LeaderboardScores leaderboard_scores = 5;
         */
        leaderboardScores: Response_LeaderboardScores;
    } | {
        oneofKind: "loadedSong";
        /**
         * @generated from protobuf field: proto.packets.Response.LoadedSong loaded_song = 6;
         */
        loadedSong: Response_LoadedSong;
    } | {
        oneofKind: "modal";
        /**
         * @generated from protobuf field: proto.packets.Response.Modal modal = 7;
         */
        modal: Response_Modal;
    } | {
        oneofKind: "modifyQualifier";
        /**
         * @generated from protobuf field: proto.packets.Response.ModifyQualifier modify_qualifier = 8;
         */
        modifyQualifier: Response_ModifyQualifier;
    } | {
        oneofKind: "modifyTournament";
        /**
         * @generated from protobuf field: proto.packets.Response.ModifyTournament modify_tournament = 9;
         */
        modifyTournament: Response_ModifyTournament;
    } | {
        oneofKind: "imagePreloaded";
        /**
         * @generated from protobuf field: proto.packets.Response.ImagePreloaded image_preloaded = 10;
         */
...
export interface Response_Connect {
    ...
    message: string;
    /**
     * @generated from protobuf field: proto.packets.Response.ConnectFailReason reason = 4;
     */
...
export interface Response_Join {
    ...
    message: string;
    /**
     * @generated from protobuf field: proto.packets.Response.JoinFailReason reason = 5;
     */
...
/**
 * @generated from protobuf message proto.packets.Response.LoadedSong
 */
...
/**
 * @generated from protobuf message proto.packets.Response.Modal
 */
...
/**
 * @generated from protobuf message proto.packets.Response.ModifyQualifier
 */
...
/**
 * @generated from protobuf message proto.packets.Response.ModifyTournament
 */
...
/**
 * @generated from protobuf message proto.packets.Response.ImagePreloaded
 */
...
/**
 * @generated from protobuf enum proto.packets.Response.ConnectFailReason
 */
...
/**
 * @generated from protobuf enum proto.packets.Response.JoinFailReason
 */
...
class Command$Type extends MessageType<Command> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* bool stream_sync_show_image */ 4:
                    ...
                    break;
                case /* proto.packets.Command.LoadSong load_song */ 5:
                    message.type = {
                        oneofKind: "loadSong",
                ...
                case /* proto.packets.Command.SendBotMessage send_bot_message */ 7:
                    ...
                    break;
                case /* proto.packets.Command.ShowModal show_modal */ 8:
                    message.type = {
                        oneofKind: "showModal",
    ...
    internalBinaryWrite(message: Command, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* proto.packets.Command.LoadSong load_song = 5; */
        ...
        /* proto.packets.Command.ShowModal show_modal = 8; */
...
class Command_LoadSong$Type extends MessageType<Command_LoadSong> {
    constructor() {
        super("proto.packets.Command.LoadSong", [
...
/**
 * @generated MessageType for protobuf message proto.packets.Command.LoadSong
 */
...
class Command_ShowModal$Type extends MessageType<Command_ShowModal> {
    constructor() {
        super("proto.packets.Command.ShowModal", [
...
/**
 * @generated MessageType for protobuf message proto.packets.Command.ShowModal
 */
...
class Request$Type extends MessageType<Request> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* proto.packets.Request.LeaderboardScore leaderboard_score */ 3:
                    ...
                    break;
                case /* proto.packets.Request.PreloadImageForStreamSync preload_image_for_stream_sync */ 4:
                    message.type = {
                        oneofKind: "preloadImageForStreamSync",
    ...
    internalBinaryWrite(message: Request, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* proto.packets.Request.PreloadImageForStreamSync preload_image_for_stream_sync = 4; */
...
class Response$Type extends MessageType<Response> {
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* proto.packets.Response.Join join */ 4:
                    ...
                    break;
                case /* proto.packets.Response.LeaderboardScores leaderboard_scores */ 5:
                    message.details = {
                        oneofKind: "leaderboardScores",
                ...
                case /* proto.packets.Response.ModifyQualifier modify_qualifier */ 8:
                    ...
                    break;
                case /* proto.packets.Response.ModifyTournament modify_tournament */ 9:
                    message.details = {
                        oneofKind: "modifyTournament",
                    ...
                    break;
                case /* proto.packets.Response.ImagePreloaded image_preloaded */ 10:
                    message.details = {
                        oneofKind: "imagePreloaded",
    ...
    internalBinaryWrite(message: Response, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* proto.packets.Response.LeaderboardScores leaderboard_scores = 5; */
        ...
        /* proto.packets.Response.LoadedSong loaded_song = 6; */
        ...
        /* proto.packets.Response.Modal modal = 7; */
        ...
        /* proto.packets.Response.ModifyQualifier modify_qualifier = 8; */
        ...
        /* proto.packets.Response.ModifyTournament modify_tournament = 9; */
        ...
        /* proto.packets.Response.ImagePreloaded image_preloaded = 10; */
...
class Response_Connect$Type extends MessageType<Response_Connect> {
    constructor() {
        super("proto.packets.Response.Connect", [
            ...
            { no: 4, name: "reason", kind: "enum", T: () => ["proto.packets.Response.ConnectFailReason", Response_ConnectFailReason] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string message */ 3:
                    message.message = reader.string();
                    break;
                case /* proto.packets.Response.ConnectFailReason reason */ 4:
    ...
    internalBinaryWrite(message: Response_Connect, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* proto.packets.Response.ConnectFailReason reason = 4; */
        if (message.reason !== 0)
...
class Response_Join$Type extends MessageType<Response_Join> {
    constructor() {
        super("proto.packets.Response.Join", [
            ...
            { no: 5, name: "reason", kind: "enum", T: () => ["proto.packets.Response.JoinFailReason", Response_JoinFailReason] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string message */ 4:
                    message.message = reader.string();
                    break;
                case /* proto.packets.Response.JoinFailReason reason */ 5:
                    message.reason = reader.int32();
                    break;
                default:
                    let u = options.readUnknownField;
    ...
    internalBinaryWrite(message: Response_Join, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* proto.packets.Response.JoinFailReason reason = 5; */
        if (message.reason !== 0)
...
class Response_LoadedSong$Type extends MessageType<Response_LoadedSong> {
    constructor() {
        super("proto.packets.Response.LoadedSong", [
...
/**
 * @generated MessageType for protobuf message proto.packets.Response.LoadedSong
 */
...
class Response_Modal$Type extends MessageType<Response_Modal> {
    constructor() {
        super("proto.packets.Response.Modal", [
            { no: 1, name: "modal_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message proto.packets.Response.Modal
 */
...
class Response_ModifyQualifier$Type extends MessageType<Response_ModifyQualifier> {
    constructor() {
        super("proto.packets.Response.ModifyQualifier", [
...
/**
 * @generated MessageType for protobuf message proto.packets.Response.ModifyQualifier
 */
...
class Response_ModifyTournament$Type extends MessageType<Response_ModifyTournament> {
    constructor() {
        super("proto.packets.Response.ModifyTournament", [
            { no: 1, name: "message", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message proto.packets.Response.ModifyTournament
 */
...
class Response_ImagePreloaded$Type extends MessageType<Response_ImagePreloaded> {
    constructor() {
        super("proto.packets.Response.ImagePreloaded", [
            { no: 1, name: "file_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message proto.packets.Response.ImagePreloaded
 */
